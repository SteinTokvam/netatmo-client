import { Administrative, Capability } from "./domain";
import { FeelLikeTemperatureAlgorithm, PressureUnit, SystemOfMeasurement, WindUnit } from "./domain/Administrative";
import { StationData } from "./domain/StationData";
import { User } from "./domain/User";
import { ModuleType } from "./domain/modules/BaseModule";
import { IndoorModule } from "./domain/modules/IndoorModule";
import { MainModule } from "./domain/modules/MainModule";
import { OutdoorModule } from "./domain/modules/OutdoorModule";
import { RainModule } from "./domain/modules/RainModule";
import { WindModule } from "./domain/modules/WindModule";
import { WirelessModule } from "./domain/modules/WirelessModule";
...
import { AdministrativeDto, DashboardDto, DeviceDto, ModuleDto, StationDataDto } from "./dto/GetStationResponse";
